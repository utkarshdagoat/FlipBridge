 ...
 * @template Route
 */
export declare abstract class BaseQuoter<CandidatePools extends V2CandidatePools | V3CandidatePools | [V3CandidatePools, V2CandidatePools, CrossLiquidityCandidatePools], Route extends V2Route | V3Route | MixedRoute> {
